...
<div class="register">
    ...
    <div class="content">
        ...
        <button  type="button" class="btn btn-primary signin" data-bs-toggle="modal" data-bs-target="#loginModal">Sign up with phone or email</button>
...
<div class="modal fade mymodal" id="loginModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
